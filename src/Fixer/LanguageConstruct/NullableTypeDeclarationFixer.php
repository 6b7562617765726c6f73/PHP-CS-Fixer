...
final class NullableTypeDeclarationFixer extends AbstractFixer implements ConfigurableFixerInterface
{
    ...
    private const string OPTION_SYNTAX_UNION = 'union';
    private const string OPTION_SYNTAX_QUESTION_MARK = 'question_mark';
    private const array PROPERTY_MODIFIERS = [T_PRIVATE, T_PROTECTED, T_PUBLIC, T_STATIC, T_VAR, FCT::T_READONLY];
