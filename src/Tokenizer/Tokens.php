...
{
    public const int BLOCK_TYPE_PARENTHESIS_BRACE = 1;
    public const int BLOCK_TYPE_CURLY_BRACE = 2;
    public const int BLOCK_TYPE_INDEX_SQUARE_BRACE = 3;
    public const int BLOCK_TYPE_ARRAY_SQUARE_BRACE = 4;
    public const int BLOCK_TYPE_DYNAMIC_PROP_BRACE = 5;
    public const int BLOCK_TYPE_DYNAMIC_VAR_BRACE = 6;
    public const int BLOCK_TYPE_ARRAY_INDEX_CURLY_BRACE = 7;
    public const int BLOCK_TYPE_GROUP_IMPORT_BRACE = 8;
    public const int BLOCK_TYPE_DESTRUCTURING_SQUARE_BRACE = 9;
    public const int BLOCK_TYPE_BRACE_CLASS_INSTANTIATION = 10;
    public const int BLOCK_TYPE_ATTRIBUTE = 11;
    public const int BLOCK_TYPE_DISJUNCTIVE_NORMAL_FORM_TYPE_PARENTHESIS = 12;
    public const int BLOCK_TYPE_DYNAMIC_CLASS_CONSTANT_FETCH_CURLY_BRACE = 13;
    public const int BLOCK_TYPE_COMPLEX_STRING_VARIABLE = 14;
    public const int BLOCK_TYPE_PROPERTY_HOOK = 15;
