...
final class FixCommandExitStatusCalculator
{
    ...
    public const int EXIT_STATUS_FLAG_HAS_INVALID_FILES = 4;
    public const int EXIT_STATUS_FLAG_HAS_CHANGED_FILES = 8;
    public const int EXIT_STATUS_FLAG_HAS_INVALID_CONFIG = 16;
    public const int EXIT_STATUS_FLAG_HAS_INVALID_FIXER_CONFIG = 32;
    public const int EXIT_STATUS_FLAG_EXCEPTION_IN_APP = 64;
